        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-[#EBF3F0]/90 border border-[#AEC9C0] text-xs space-y-3">
            ...
            <p className="text-[11px] text-[#5C6E68] leading-relaxed">
              Como ya completaste tu cuestionario inicial, tu contexto clínico está listo para la Dra. Lorena. Escríbenos a nuestra línea de WhatsApp (+57 311 550 7896) para coordinar la fecha y hora de tu cita.
            </p>
            <a
              href={`https://wa.me/573115507896?text=${encodeURIComponent(
                step1Data?.fullName
            ...
            >
              ...
              <span>Agendar cita médica vía WhatsApp (+57 311 550 7896)</span>
            </a>
          </div>
