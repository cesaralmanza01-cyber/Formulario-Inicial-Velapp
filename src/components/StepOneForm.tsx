        ...
        <div className="mt-4 p-4 sm:p-5 rounded-2xl bg-[#EAF1F8]/80 border border-[#8FAFD1]/30 flex items-start gap-3.5 shadow-2xs">
          ...
          <div className="text-xs sm:text-sm text-[#2E3A36]/90 leading-relaxed space-y-1">
            ...
            <p className="text-[#5C6E68]">
              Cada detalle de este formulario lo revisa personalmente la{' '}
              <strong className="font-medium text-[#2E3A36]">Dra. Lorena Castro</strong> antes
              de tu cita, para diseñar una guía médica adaptada a tu historia y biología.
            </p>
          </div>
        </div>
      </div>
